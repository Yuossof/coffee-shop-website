...
function Home() {
  return <div id="top"><Navbar /><main>
    <section className="grain-section w-full border-b border-line py-12 md:py-20"><Container className="grid items-center gap-10 md:grid-cols-[.9fr_1.1fr] md:gap-20">
      ...
      <figure className="paper-frame order-1 aspect-[3/2] md:order-2"><img src={`${IMAGE}d8b655d97a49cd5daa2d57af77fef0d04138230a?width=1104`} alt="Latte and croissant on a wooden table" className="h-full w-full object-cover" /><figcaption className="tape-note">morning ritual no. 01</figcaption></figure>
    </Container></section>
    ...
    <section className="grain-section w-full border-y border-line bg-paper py-16 md:py-24"><Container className="grid items-center gap-10 md:grid-cols-[1fr_1.15fr] md:gap-20"><div><p className="eyebrow">Barista pairings</p><h2 className="mt-3 text-4xl leading-tight md:text-5xl">Brewed for the bite.</h2><p className="mt-6 max-w-md text-base leading-7 text-ink-soft">Our baristas pair each week&apos;s coffee with something warm from the oven: bright fruit, dark chocolate, or the unmistakable comfort of sourdough.</p><a href="/story" className="mt-8 inline-flex items-center gap-2 font-label text-xs tracking-[1px] text-oxblood">Read our story <IconArrowRight /></a></div><div className="grid grid-cols-2 gap-4"><figure className="paper-frame"><img src={`${IMAGE}09b9e31c18034d83946ec81875b884caa82a7b07?width=528`} alt="Iced latte with layered milk" className="aspect-square w-full object-cover" /><figcaption className="photo-caption">cold latte / bright fruit</figcaption></figure><figure className="paper-frame mt-10"><img src={`${IMAGE}22737b70d859c9148306f7ed4ba269b4b2a41e87?width=528`} alt="Sourdough loaf on a bakery counter" className="aspect-square w-full object-cover" /><figcaption className="photo-caption">country loaf / dark roast</figcaption></figure></div></Container></section>
